...
import { BookOpen, Users, Award, Code, Monitor, Palette, Briefcase, Target } from 'lucide-react';
    ...
    <section className="py-20 bg-background">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="text-center mb-8 space-y-4">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto" style={{fontFamily: 'var(--font-secondary)'}}>
            We're committed to delivering excellence in education through our comprehensive programs designed to transform your career in just 90 days.
          </p>
        </div>
        ...
        <div className="grid grid-cols-3 gap-8 mb-16 max-w-3xl mx-auto text-center">
          <div>
            <div className="text-4xl font-bold mb-1" style={{fontFamily: 'var(--font-primary)'}}>
              06 Years
            </div>
            <div className="text-sm text-muted-foreground" style={{fontFamily: 'var(--font-secondary)'}}>
              Experience
            </div>
          </div>
          <div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12 items-center">
            ...
            <div className="space-y-8 lg:space-y-12">
              ...
              <div className="text-left lg:text-right space-y-3">
                <div className="flex items-center gap-3 lg:flex-row-reverse lg:justify-end">
                  ...
                  <h3 className="text-xl font-bold" style={{fontFamily: 'var(--font-primary)'}}>
                    Full Stack Development
                  </h3>
                </div>
                <p className="text-sm text-muted-foreground" style={{fontFamily: 'var(--font-secondary)'}}>
                  Master both frontend and backend technologies with hands-on projects and real-world applications.
                </p>
              </div>
              ...
              <div className="text-left lg:text-right space-y-3">
                ...
                <p className="text-sm text-muted-foreground" style={{fontFamily: 'var(--font-secondary)'}}>
                  Learn machine learning, data analytics, and AI with industry-standard tools and frameworks.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-8 lg:space-y-12">
              ...
              <div className="text-left space-y-3">
                ...
                <p className="text-sm text-muted-foreground" style={{fontFamily: 'var(--font-secondary)'}}>
                  Build scalable applications with AWS, Docker, Kubernetes and modern deployment practices.
                </p>
              </div>
              ...
              <div className="text-left space-y-3">
                ...
                <p className="text-sm text-muted-foreground" style={{fontFamily: 'var(--font-secondary)'}}>
                  Create stunning user experiences with design thinking, Figma, and modern design principles.
                </p>
              </div>
            </div>
